...
Critical research conclusion: no single source satisfies all 8 required labels. Phase 2 must include a class-gap audit and targeted collection strategy for Micro, Station Wagon, and Open Wheel/F1.
...
3. manifest records counts and known gaps.
4. dedup/split command exists.
5. balance audit file exists.
