...
<must_haves>
- Covers requirement IDs: UI-04, UI-05.
...
<task id="P5-03-T1" type="execute">
  ...
  <acceptance_criteria>
    ...
    - At least one project file or documentation artifact relevant to `03-results-visualization` exists after execution.
  </acceptance_criteria>
</task>

<task id="P5-03-T2" type="execute">
