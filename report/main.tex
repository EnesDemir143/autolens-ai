...
Veri seti Kaggle ve Hugging Face üzerinde yayımlanmış açık veri kümelerinden toplanmış, sınıflar arası dengesizlik sınıf ağırlıklı hata fonksiyonları ile ele alınmıştır. Belirlenen 95 MB model boyutu kısıtı doğrultusunda ONNX formatında paketlenmiş ve canlı demo web arayüzü ile sunulmuştur.
